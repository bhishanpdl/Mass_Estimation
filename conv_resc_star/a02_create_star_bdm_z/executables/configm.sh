...
fixed_redshift=0.5  # the single source galaxy redshift to use (bdfactors, bdweights)
...
bd_weights="physics_settings/bd_weights_z0.5.txt" # jedisim_config, jedisimulate
bd_factors="physics_settings/bd_factors.txt" # jedisim_config, jedisimulate
bd_flux_rat="physics_settings/bd_flux_rat_z0.5.txt" # fr, frb, frd written by scaled_bd_flux_rat.py
...
# line 20000: jedisim_out/out0/distorted_12/distorted_12419.fits
#
...
# jeditransform creates jedisim_out/out0/scaled_bulge/trial1_dislist.txt along with 20000 .gz stamps
...
#
#  e.g. jedisim_out/out0/dislist.txt looks like this: (was created by jeditransform)
# 6813 888 10 23 1.500000 jedisim_out/out0/transformed_0/transformed_.fits.gz out0/distorted_0/distorted_0.fits
