 ...
 * Author      : Dan Parker; Physics PhD Student, Brown University
 ...
 * Run         : ./jedirescale out1/trial0_HST_convolved.fits 0.06 0.2 480 480 out1/rescaled_convolved_lsst_0.fits
 *
 *
